...
class MakeRide extends StatefulWidget {
  ...
  @override
  State<MakeRide> createState() =>
      _MakeRideState(location, date, time, phone, college);
}

class _MakeRideState extends State<MakeRide> {
  final String location;
  final DateTime date;
  final DateTime time;
  final String phone;
  final String college;
  _MakeRideState(this.location, this.date, this.time, this.phone, this.college);
                    ...
                    onPressed: () async {
                      ...
                      if (_currentDate != null &&
                        ...
                        if (_formKey.currentState!.validate() &&
                          ...
                          //show Fluttertoast
                          Fluttertoast.showToast(msg: "Ride listed");
